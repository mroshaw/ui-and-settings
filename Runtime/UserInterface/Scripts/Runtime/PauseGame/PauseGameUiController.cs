...
{
    /// <summary>
    /// Simple implementation of a "Pause Game" UI.
    /// Hook the events into a PauseGameController component
    /// </summary>
    public class PauseGameUiController : Window
    {
        ...
        [BoxGroup("UI Events")] [SerializeField] private UnityEvent onBackButtonClickEvent;
